...
timeref=[];
timeref[31557600000] = 'Looong time ago';
timeref[29030400000] = 'One year ago';
timeref[14515200000] = 'Half a year ago';
timeref[9676800000] = 'A few months ago';
timeref[7257600000] = 'Three months ago';
...
timeref[345600000] = 'A few days ago';
timeref[259200000] = 'Three days ago';
...
timeref[60000] = 'A minute ago';
timeref[30000] = 'Less than a minute ago';

timeRefChecker=[];

currentTimeRef=30000;
...
findNearestTimeRef = function(timestamp){
	...
	//don't display a timestamp if a message has just been written (less than 5 min)
	//strange behaviour in FF
	// for (var t in timeref) {
	// 	// console.log(t);
	// 	// console.log(timeref[t]);
	// 	if(diffToNow < t)
	// 		return t;
	// }
	...
	if( diffToNow < 5184000000 )
		return 5184000000;
	if( diffToNow < 7257600000 )
		return 7257600000;
	if( diffToNow < 9676800000 )
		return 9676800000;
	if( diffToNow < 14515200000 )
		return 14515200000;
	if( diffToNow < 29030400000 )
		return 29030400000;
...
imageExp = function(){
	...
	$('.message-image:not(.bound)').addClass('bound').bind('click',  function(){
...
goOnline = function(){
	...
	Meteor.call('setUserStatus', Session.get('screenname') ,Session.get('roomid'),Session.get('avatar'),'online');
}

goOffline = function(){
	// console.log('marked as offline');
	Meteor.call('setUserStatus', Session.get('screenname') ,Session.get('roomid'),Session.get('avatar'),'offline');
}
