...
Template.settings.events({
	...
	'click #removeMessagesRoom':function(evnt){
		evnt.preventDefault();
		if(confirm('Are you sure? Do you really want to remove your messages from this chatroom?')){
	...
	'click #removeMessages':function(evnt){
		evnt.preventDefault();
		if(confirm('Are you sure? Do you really want to remove all your messages?')){
